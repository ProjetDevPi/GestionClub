...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ClubBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'ClubBundle\\Entity');
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\PHPDriver([0 => ($this->targetDirs[3].'\\src\\UserBundle\\Resources\\config\\doctrine')]), 'UserBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'ClubBundle' => 'ClubBundle\\Entity']);
