...
tb.addMaterialCommandToSideMenu("Club", FontImage.MATERIAL_INFO, e -> {
    displayClub a = new displayClub(theme);
    a.hi.show();
            
});
tb.addMaterialCommandToSideMenu("Myclub", FontImage.MATERIAL_INFO, e -> {
   new displayClubMembre(current).show();
